...
const Home: NextPage = () => {
  ...
  const [message, setMessage] = useState<string>("WE'RE MARRY SOON");

  const timeToDays = time * 60 * 60 * 24 * 1000;

  // let countDownDate = new Date().getTime() + timeToDays;
  let countDownDate = new Date("2022-11-25T20:00:00Z").getTime();
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-[#1e1f29]">
      <Head>
        <title>Cheok and Huibao wedding countdown</title>
